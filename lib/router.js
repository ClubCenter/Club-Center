Router.configure({
  ...
  waitOn: function() {
    return [Meteor.subscribe('notifications'),  Meteor.subscribe('forums'), Meteor.subscribe('accountsData'), Meteor.subscribe('products'), Meteor.subscribe('payments'), Meteor.subscribe('invoices')]
  }
});
